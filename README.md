# For final project:
- Polynomial scripts are in the folder `polynomial`
- Modulation scripts are in the folder `modulation`
- Some provided scripts have been adjusted for special needs.
- Evaluations are run through `batch_poly_lpvDS.m` and `batch_ch3_ex4-lpvDS`
- Evaluations matrics, plots and plot script are in the folder `exp_csv`.
